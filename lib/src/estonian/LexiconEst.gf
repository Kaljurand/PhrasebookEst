...
concrete LexiconEst of Lexicon = CatFin ** open MorphoEst, ParadigmsFin in {
...
lin
  ...
  bank_N = mkN "pankki" ;
  beautiful_A = mkA (mkN "ilus") "ilusam" "ilusaim" ;
  become_VA = mkVA (mkV "tulla") (casePrep translative) ;
  -- TODO: Putting this in caused: gf: evalTerm (tk)
  -- beer_N = mkN "õlu" "õlusid" ;
